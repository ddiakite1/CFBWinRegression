...
secSum <- sec %>% group_by(year) %>% summarise(rushATT = mean(r_att), passATT = mean(p_att))
b1gSum <- b1g %>% group_by(year) %>% summarise(rushATT = mean(r_att), passATT = mean(p_att))
b12Sum <- b12 %>% group_by(year) %>% summarise(rushATT = mean(r_att), passATT = mean(p_att))
pacSum <- pac %>% group_by(year) %>% summarise(rushATT = mean(r_att), passATT = mean(p_att))
accSum <- acc %>% group_by(year) %>% summarise(rushATT = mean(r_att), passATT = mean(p_att))
...
p5 <- full_join(sec, 
      full_join(b1g, 
      full_join(b12, 
      full_join(pac, acc, by=NULL), by=NULL), by=NULL), by=NULL) %>% group_by(year)
```
